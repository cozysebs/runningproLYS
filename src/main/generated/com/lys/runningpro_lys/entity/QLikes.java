...
public class QLikes extends EntityPathBase<Likes> {
    ...
    private static final long serialVersionUID = 57001973L;
    ...
    public final EnumPath<com.lys.runningpro_lys.entity.fieldenum.Type> type = createEnum("type", com.lys.runningpro_lys.entity.fieldenum.Type.class);
